      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div className="flex">
          ...
          <div className="space-y-1">
            <p className="text-xs text-gray-600 dark:text-gray-500">Di động</p>
        ...
        <div className="flex">
          ...
          <div className="space-y-1">
            <p className="text-xs text-gray-600 dark:text-gray-500">Địa chỉ</p>
            <h6 className="font-medium text-gray-700 dark:text-white">
        ...
        <div className="flex">
          ...
          <div className="space-y-1">
            <p className="text-xs text-gray-600 dark:text-gray-500">Ngày sinh</p>
